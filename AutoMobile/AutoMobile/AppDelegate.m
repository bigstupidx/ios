...
//  AutoMobile
//
//  Created by Zune Moe on 31/12/13.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSDictionary *navbarTitleTextAttributes = [NSDictionary dictionaryWithObjectsAndKeys:
                                               ...
                                               [UIFont fontWithName:@"AyarWagaung" size:20.0],NSFontAttributeName,nil]; //pxColorWithHexValue:@"9a8624"
    //
    ...
    [[UITabBarItem appearance] setTitleTextAttributes:[NSDictionary dictionaryWithObjectsAndKeys:
                                                      [UIFont fontWithName:@"AyarWagaung" size:13.0f], NSFontAttributeName,
                                                      [UIColor whiteColor], NSForegroundColorAttributeName,
                                                      nil] forState:UIControlStateNormal];
    
//    if([self.window respondsToSelector:@selector(tintColor)]) {
//        self.window.tintColor = [UIColor whiteColor];//[UIColor colorWithRed:251.0/255.0 green:147.0/255.0 blue:51.0/255.0 alpha:1.0];
//    }
