...
@interface CheckinEventsVC () <UITableViewDataSource, UITableViewDelegate, UIViewControllerTransitioningDelegate>
...
@implementation CheckinEventsVC
{
    NSDictionary *colors;
}
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [tracker set:kGAIScreenName value:@"Me Checkin Events History View Controller"];
