...
@property (nonatomic) BOOL isLongPressed; // SMT
@end
...
//        [self addGestureRecognizer:_longPressRecognizer];
        ...
        self.itemBGColor = [UIColor darkTextColor].CGColor;
        self.itemBGHighlightedColor = [UIColor blueColor].CGColor;
...
- (void) longPressDetected:(UIGestureRecognizer*) gestureRecognizer
{
    if (gestureRecognizer.state == UIGestureRecognizerStateBegan) {
        ...
        _isLongPressed = YES;
        [self reloadData];
        self.layer.backgroundColor = [UIColor colorWithWhite:0.1f alpha:.5f].CGColor;
        self.isShowing = YES;
