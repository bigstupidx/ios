...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [tracker set:kGAIScreenName value:@"Event City Menu View Controller"];
...
{
    [[NSNotificationCenter defaultCenter] postNotificationName:@"EventLeftMenuDismissed" object:nil userInfo:@{@"city": titles[self.tableView.indexPathForSelectedRow.row]}];
