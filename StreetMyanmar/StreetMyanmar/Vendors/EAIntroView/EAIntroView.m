...
- (void)buildFooterView {
    ...
    self.pageControl.pageIndicatorTintColor = [UIColor colorWithRed:50.0/255.0 green:145.0/255.0 blue:211.0/255.0 alpha:1.0];
    self.pageControl.currentPageIndicatorTintColor = [UIColor colorWithRed:26.0/255.0 green:80.0/255.0 blue:116.0/255.0 alpha:1.0];
    ...
    [self.skipButton setTitleColor:[UIColor colorWithRed:26.0/255.0 green:80.0/255.0 blue:116.0/255.0 alpha:1.0] forState:UIControlStateNormal];
